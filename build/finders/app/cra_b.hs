...
-- cra_b_f1
splitSents (Sentence (Quant_sent Universal [Name x,Name y] (Bool_sent (BinOp Implication (Bool_sent (Junction Conjunction [Atom_sent (Atom (Name_term a_0) [Term_seq (Name_term x_1)]) _,Atom_sent (Atom (Name_term b_0) [Term_seq (Name_term x_2),Term_seq (Name_term y_1)]) _]) _) (Quant_sent Existential [Name z_0] (Atom_sent (Atom (Name_term c_0) [Term_seq (Name_term y_2),Term_seq (Name_term z_1)]) _) _)) _) _))  | (x_0 == x_1) && (x_0 == x_2) && (y_0 == y_1) && (y_0 == y_2) && (z_0 == z_1) && (c_0 == Id.mkSimpleId "hasDataValue") = Just ("cra_b_f1", [show a_0, show b_0, show c_0]) | otherwise = Nothing
