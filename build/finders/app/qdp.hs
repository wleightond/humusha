...
-- QDP_f1
splitSents (Sentence (Quant_sent Universal [Name x_0] (Bool_sent (BinOp Implication (Atom_sent (Atom (Name_term a_0) [Term_seq (Name_term x_1)]) _) (Quant_sent Existential [Name y_0] (Bool_sent (Junction Conjunction [Atom_sent (Atom (Name_term b_0) [Term_seq (Name_term y_1)]) _,Atom_sent (Atom (Name_term c_0) [Term_seq (Name_term x_2),Term_seq (Name_term y_2)]) _,Quant_sent Existential [Name z_0] (Bool_sent (Junction Conjunction [Atom_sent (Atom (Name_term d_0) [Term_seq (Name_term z_1)]) _,Atom_sent (Atom (Name_term e_0) [Term_seq (Name_term y_3),Term_seq (Name_term z_2)]) _,Quant_sent Existential [Name v_0] (Atom_sent (Atom (Name_term f_0) [Term_seq (Name_term z_3),Term_seq (Name_term v_1)]) _) _]) _) _]) _) _)) _) _))  | (x_0 == x_1) && (x_0 == x_2) && (y_0 == y_1) && (y_0 == y_2) && (y_0 == y_3) && (z_0 == z_1) && (z_0 == z_2) && (z_0 == z_3) && (v_0 == v_1) && (c_0 == Id.mkSimpleId "has-quality") && (e_0 == Id.mkSimpleId "has-quale") = Just ("QDP_f1", [show a_0, show b_0, show c_0, show d_0, show e_0, show f_0]) | otherwise = Nothing
