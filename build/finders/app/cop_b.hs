...
-- COP_b_f1
splitSents (Sentence (Quant_sent Universal [Name x_0] (Bool_sent (BinOp Implication (Atom_sent (Atom (Name_term a_0) [Term_seq (Name_term x_1)]) _) (Quant_sent Existential [Name y_0] (Bool_sent (Junction Conjunction [Atom_sent (Atom (Name_term b_0) [Term_seq (Name_term y_1)]) _,Atom_sent (Atom (Name_term c_0) [Term_seq (Name_term y_2),Term_seq (Name_term x_2)]) _]) _) _)) _) _))  | (x_0 == x_1) && (x_0 == x_2) && (y_0 == y_1) && (y_0 == y_2) && ((c_0 == Id.mkSimpleId "total-constant-participant-in") || (c_0 == Id.mkSimpleId "constant-participant-in") || (c_0 == Id.mkSimpleId "total-temporary-participant-in") || (c_0 == Id.mkSimpleId "temporary-participant-in") || (c_0 == Id.mkSimpleId "participant-in")) = Just ("COP_b_f1", [show a_0, show b_0, show c_0]) | otherwise = Nothing
